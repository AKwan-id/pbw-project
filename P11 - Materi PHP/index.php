...
<div class="container py-4">
    <div class="card shadow-sm">
        ...
        <div class="card-body p-0">
            <input type="text" id="searchInput" placeholder="Cari nama, atau email.." onkeyup="cariUsers()">
    ...
    function cariUsers() {
        ...
        .then(data => {
            ...
            if (data.length > 0 && !data.error) {
                ...
                tbody = `<tr><td colspan="5" class="text-center text-muted py-3">Tidak ditemukan.</td></tr>`;
            }
